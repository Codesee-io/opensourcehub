...
repoUrl: https://github.com/thomaspoignant/go-feature-flag
description: A simple and complete feature flag solution, without any complex backend system to install, all you need is a file as your backend. 🎛️
maintainer: thomaspoignant
created: 2022-10-13T16:05:25.298Z
languages:
  - Go
tags:
  - Tools
currentlySeeking:
  - Maintainers
websiteUrl: https://gofeatureflag.org
twitterUrl: https://twitter.com/gofeatureflag
