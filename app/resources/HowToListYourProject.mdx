...
We’re thrilled to have you to Open-Source Hub! It's super easy to get started, and should only take about 11 minutes.
...
1. Create your project's `.mdx` file
   ...
   1. Copy/paste the contents of [`projects/_template.mdx`](https://raw.githubusercontent.com/Codesee-io/opensourcehub/main/projects/_template.mdx) into that file
...
[<img alt="CodeSee Map preview" src="https://github.com/Codesee-io/opensourcehub/blob/main/docs/codebase-map.png?raw=true" width="500"></img>](https://app.codesee.io/maps/public/848e3630-1650-11ec-8bc1-7d4a4822cc27)
